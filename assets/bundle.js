...
/***/ function(module, exports, __webpack_require__) {
	...
	store.dispatch((0, _actions.addTodo)('hello world1'));
	store.dispatch((0, _actions.addTodo)('hello world2'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(164),
	    isHostObject = __webpack_require__(165),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function todos() {
		...
		switch (action.type) {
			...
			case _actions.COMPLETE_TOTO:
				return [state.slice(0, action.index), Object.assign({}, state[action.index], { completed: true }), state.slice(action.index + 1)];
			default:
				return state;
		}
	}
	...
	function setVisibility() {
		var visibility = arguments.length <= 0 || arguments[0] === undefined ? _actions.VisibiltyFilter.SHOW_ALL : arguments[0];
		var action = arguments[1];
...
/***/ function(module, exports) {
	...
	var COMPLETE_TOTO = exports.COMPLETE_TOTO = "COMPLETE_TOTO";
	var SET_VISIBILITY_FILTER = exports.SET_VISIBILITY_FILTER = "SET_VISIBILITY_FILTER";

	var VisibiltyFilter = exports.VisibiltyFilter = {
		SHOW_ALL: 'SHOW_ALL',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
		...
		_createClass(App, [{
			...
			key: 'onTodoClick',
			value: function onTodoClick(index) {
				console.log(index);
			}
		}, {
			key: 'render',
			value: function render() {
				var todos = [{ text: 'todo1', completed: true }, { text: 'todo1', completed: false }];
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_AddTodo2.default, { onAddClick: this.onAddTodo.bind(this) }),
					_react2.default.createElement(_TodoList2.default, { todos: todos, onTodoClick: this.onTodoClick.bind(this) })
				);
			}
		}]);
		...
		_createClass(TodoList, [{
			...
			value: function getTodos() {
				...
				return this.props.todos.map(function (todo, index) {
					return _react2.default.createElement(_Todo2.default, _extends({}, todo, { key: index, onItemClick: function onItemClick() {
